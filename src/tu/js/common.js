...
function getFallbackSidebarTemplate() {
  ...
  <aside class="app-sidebar" id="appSidebar">
    ...
    <nav class="sidebar-nav">
      ...
      <div class="nav-section-title">Hệ thống liên kết</div>
      <a href="../../Toan/html/postModeration.html" class="nav-item">
        <div class="nav-item-content"><span class="material-symbols-outlined" style="color:#ef4444;">verified_user</span><span>Kiểm duyệt &amp; CSKH</span></div>
        <span class="nav-badge" style="background:rgba(239,68,68,0.2); color:#ef4444;">18</span>
      </a>
      <a href="../../truong/html/index.html" class="nav-item">
        <div class="nav-item-content"><span class="material-symbols-outlined" style="color:#10b981;">storefront</span><span>Kênh Người Bán</span></div>
      </a>
      <a href="../../tin/html/home.html" class="nav-item">
        <div class="nav-item-content"><span class="material-symbols-outlined" style="color:#3b82f6;">shopping_bag</span><span>Chợ ComicHub</span></div>
      </a>
      <a href="../../index.html" class="nav-item">
        <div class="nav-item-content"><span class="material-symbols-outlined" style="color:#ea580c;">hub</span><span style="font-weight:600; color:#ea580c;">Master Portal</span></div>
      </a>
    </nav>
